...
(func (export "_start")
  ...
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 01))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 02))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 03))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 04))))
  (if (global.get $start.runSlow)
    (then
      (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 05))))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 06))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 07))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 08))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 09))))
  (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 10))))
  (if (global.get $start.runSlow)
    (then
  ...
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 17))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 18))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 19))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 20))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 21))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 22))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 23))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 24))))
  ;; (local.set $err (i32.add (local.get $err) (call $start.runDay (i32.const 25))))
