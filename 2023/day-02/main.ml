...
module Cubes = struct
  ...
  let plus { r = r0; g = g0; b = b0 } { r = r1; g = g1; b = b1 } : t = { r = r0 + r1; g = g0 + g1; b = b0 + b1 }
  let zero : t = { r = 0; g = 0; b = 0 }
  let red r : t = { r; g = 0; b = 0 }
  let green g : t = { r = 0; g; b = 0 }
  let blue b : t = { r = 0; g = 0; b }
  ...
  let join { r = r0; g = g0; b = b0 } { r = r1; g = g1; b = b1 } : t = { r = max r0 r1; g = max g0 g1; b = max b0 b1 }
...
module Game = struct
  ...
  let of_string str : t =
    ...
    | [ idString; drawString ] -> (
        ...
        | [ "Game"; id ] ->
            { id = int_of_string id; draws = List.map Cubes.of_string @@ String.split_on_char ';' drawString }
        | _ -> fail "bad parse")
    | _ -> fail "bad parse"
